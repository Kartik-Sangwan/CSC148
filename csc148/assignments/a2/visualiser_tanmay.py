...
import pygame
from tm_trees_final import TMTree, FileSystemTree

from papers_final import PaperTree
...
if __name__ == '__main__':
    ...
    python_ta.check_all(config={
        'allowed-import-modules': [
            'python_ta', 'typing', 'pygame', 'tm_trees_final', 'papers'
        ],
    ...
    run_treemap_file_system('/Users/kartiksangwan/Desktop/uoft/csc108/assignment1 copy/a1/pyta/pylint/test/functional')
